...
const dataStore = {
  ...
  "@progress-pushups": 0,
  "@progress-legraises": 0,
  "@progress-squats": 0,
  "@progress-pullups": 0,
  "@progress-handstands": 0,
  "@progress-bridges": 0
};
...
class ExerciceList extends React.Component {
  render() {
    let {exercices} = this.props;
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
...
class PushupsScreen extends React.Component {
  render() {
    let exercices = dataStore['@muscleGroups']['pushups']['exercices'];
    return (
...
class PullupsScreen extends React.Component {
  render() {
    let exercices = dataStore['@muscleGroups']['pullups']['exercices'];
    return (
      <ExerciceList exercices={exercices}/>
    );
  }
...
class LegraiseScreen extends React.Component {
  render() {
    let exercices = dataStore['@muscleGroups']['legraise']['exercices'];
    return (
      <ExerciceList exercices={exercices}/>
    );
  }
...
class SquatsScreen extends React.Component {
  render() {
    let exercices = dataStore['@muscleGroups']['squats']['exercices'];
    return (
      <ExerciceList exercices={exercices}/>
    );
  }
...
class BridgesScreen extends React.Component {
  render() {
    let exercices = dataStore['@muscleGroups']['bridges']['exercices'];
    return (
      <ExerciceList exercices={exercices}/>
    );
  }
...
class HandstandsScreen extends React.Component {
  render() {
    let exercices = dataStore['@muscleGroups']['handstands']['exercices'];
    return (
      <ExerciceList exercices={exercices}/>
    );
  }
